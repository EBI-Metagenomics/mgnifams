...
workflow GENERATE_FAMILIES {
    ...
    refined_families = REFINE_FAMILIES(matched_anti_defence_proteins, clusters_pkl, refined_families_tsv, mgnifams_fasta, discarded_clusters,params.iteration)
