...
workflow REMOVE_REDUNDANCY {
    ...
    non_redundant         = REMOVE_REDUNDANT_AND_TM(hhr_all_ch, mapping, tm_ids_ch, refined_fam_proteins, rep_fa_ch, params.redundant_threshold, params.similarity_threshold)
