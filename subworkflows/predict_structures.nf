...
include { EXTRACT_FIRST_STOCKHOLM_SEQUENCES_FROM_FOLDER } from "../modules/local/extract_first_stockholm_sequences_from_folder.nf"
include { ESMFOLD                                       } from "../modules/local/esmfold/esmfold.nf"
include { EXTRACT_LONG_FA                               } from "../modules/local/extract_long_fa.nf"
include { ESMFOLD_CPU                                   } from "../modules/local/esmfold/esmfold_cpu.nf"
include { EXTRACT_ESMFOLD_SCORES                        } from "../modules/local/extract_esmfold_scores.nf"
include { PARSE_CIF                                     } from "../modules/local/parse_cif.nf"
