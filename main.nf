...
workflow {
    ...
    // FASTA_OMAINANNOTATION -----
    families.reps_fasta
        .map { filepath -> [ [id:'mgnifams_annotate'], [file(filepath)] ] }
        .set { input }
    ...
    annotations_ch = CONCAT_ANNOTATIONS(annotations_ch.inteproscan_tsv.concat(annotations_ch.eggnogmapper_csv, annotations_ch.blastp_csv).collect(), 'strategy90')
