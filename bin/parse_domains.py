...
if __name__ == "__main__":
    ...
    query_results_files = os.listdir(args.query_results)
    refined_families_df = pd.read_csv(args.refined_families, sep='\t', header=None, names=['family_id', 'protein_name'])

    os.makedirs(args.output_dir, exist_ok=True)
    for tsv in query_results_files:
        file_path = os.path.join(args.query_results, tsv)
        ...
        out_file = os.path.join(args.output_dir, f"{family_id}.json")
