...
def parse_tm_file(input_file, output_dir, csv_out):
    ...
    label_map = {
        "I": {"name": "Inside (cytosolic)", "className": "tm-i", "color": "#619CFF"},
        "M": {"name": "Transmembrane α-helix", "className": "tm-m", "color": "#F8766D"},
        "O": {"name": "Outside (extracellular)", "className": "tm-o", "color": "#00BA38"},
        "S": {"name": "Signal peptide", "className": "tm-s", "color": "#E69F00"},
        "B": {"name": "Transmembrane β-strand", "className": "tm-b", "color": "#800080"},
        "P": {"name": "Periplasm / lumen", "className": "tm-p", "color": "#00CED1"},
    }
    ...
    for i in range(0, len(lines), 3):
        ...
        features = {"sequence": seq, "features": []}
        ...
        csv_rows.append(
            (protein_id, percents["I"], percents["M"], percents["O"], percents["S"], percents["B"], percents["P"])
        )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Convert DeepTMHMM predictions to FeatureViewer JSON and CSV summaries."
    )
