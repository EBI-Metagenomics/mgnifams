...
def write_mgnifam_pfams(i, mgnifams_out_dir, output_dir):
...
def write_mgnifam_folds(i, mgnifams_out_dir, output_dir):
...
def main():
    ...
    write_mgnifam_pfams(i, mgnifams_out_dir, output_dir)
    write_mgnifam_folds(i, mgnifams_out_dir, output_dir)
