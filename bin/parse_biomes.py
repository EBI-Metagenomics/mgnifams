...
if __name__ == "__main__":
    ...
    parser.add_argument("biome_mapping", help="Path to the biome id to names mapping tsv file")
    ...
    if not os.path.exists(args.biome_mapping):
        raise FileNotFoundError(f"The file {args.biome_mapping} does not exist.")

    biome_mapping_df = pd.read_csv(args.biome_mapping, sep='\t', header=None, names=['id', 'name'])
