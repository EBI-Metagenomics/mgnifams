...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", help="Path to the output directory with per family CSV biome distributions")
    ...
    for tsv in query_results_files:
        ...
        out_file = os.path.join(args.output_dir, f"{basename}.csv")
